...
#show raw.where(block: true): it => block(
  fill: rgb("f5f7f1"),
  stroke: (paint: rgb("cdd7c5"), thickness: 0.5pt),
  inset: 9pt,
  radius: 4pt,
  width: 100%,
)[#it]
...
#let editorial_note(body) = block(
  fill: rgb("f7f2de"),
  stroke: (paint: rgb("dccb86"), thickness: 0.5pt),
  inset: 10pt,
  radius: 4pt,
  width: 100%,
)[
...
#let checkpoint(body) = block(
  fill: rgb("eef5ff"),
  stroke: (paint: rgb("b8cce6"), thickness: 0.5pt),
  inset: 10pt,
  radius: 4pt,
  width: 100%,
)[
...
#let caution(body) = block(
  fill: rgb("fff2f0"),
  stroke: (paint: rgb("e2b7ac"), thickness: 0.5pt),
  inset: 10pt,
  radius: 4pt,
  width: 100%,
)[
